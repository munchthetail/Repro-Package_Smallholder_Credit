//this file collects the FIES data processed in the R code and creates teh Food Consumption Score 
	...
	//Food Insecurty Experience Scale FIES 
		...
		import delimited "`base'/R Code/R Data Landing/household_probs_long.csv", clear
	...
	//in post harvest houeshold survey
		//wave 5
			...
			use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect5c_harvestw5.dta", clear
		...
		//wave 4
			//last section of food consumption is exactly what we need presubably by design
			use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect10c_harvestw4.dta", clear
	...
	//pulling data
		...
		save "`base'/Stata Code/Stata Data Landing/Master_Food_Security_indexs_both_waves_long.dta",replace