...
//we also average expenditures from the post harvest and post planting surveys
	...
	//HOUSEHOLD SURVEY
		//post havest
			//food expenditures
				use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect5b_harvestw5.dta", clear
			...
			//food away from home
				use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect5a_harvestw5.dta", clear
		...
		//post planting
			//food expenditures
				use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect6b_plantingw5.dta", clear
			...
			//food away from home
				use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect6a_plantingw5.dta", clear
	...
	//saving
	save "`base'/Stata Code/Stata Data Landing/food_expenditures_w5.dta", replace