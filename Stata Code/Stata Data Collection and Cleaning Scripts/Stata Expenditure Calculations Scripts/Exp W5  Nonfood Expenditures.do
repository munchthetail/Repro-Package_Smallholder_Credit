// Will Hankins edit 9/16/25
	...
	//Post Harvest
		//household survey
			//general expenditures
				//7 day horizon
					use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect6a_harvestw5.dta", clear
				...
				//month horizon
					use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect6b_harvestw5.dta", clear
				...
				//year horizon
					use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect6c_harvestw5.dta", clear
			...
			//harvest: education spending post harvest (no pre harvest amount) 22/23 school year
				use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect2_harvestw5.dta", clear
			...
			//harvest: childcare expenses child <= 7
				use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect2c_harvestw5.dta", clear
			...
			//harvest: nonfarm enterprise expenses -- business expenses
				use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect8b_harvestw5.dta", clear
			...
			//harvest: housing expenses -- rent 
				use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect9_harvestw5.dta", clear
	...
	//Post Planting
		//household survey
			//planting: general expenditures
				//7 day horizon
					use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect7a_plantingw5.dta", clear
				...
				//month horizon
					use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect7b_plantingw5.dta", clear
				...
				//year horizon
					use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect7c_plantingw5.dta", clear
			...
			//planting: health expenses --- this might overlap with expenses from section 7c so I will exclude it from the final figures
				use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect3_plantingw5.dta", clear
	...
	save "`base'/Stata Code/Stata Data Landing/nonfood_expenditures_household_w5.dta", replace