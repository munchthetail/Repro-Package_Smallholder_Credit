...
//(fertilizer, seeds, and machinery) and is collected in "Exp Master Pulls.do"
	...
	//Post Planting
		//agricultural survey
			...
			//annual
			use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect11e1_plantingw5.dta", clear
				keep hhid s11eq11
			...
			//annual
				use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/sect11e2_plantingw5.dta", clear
		...
		//Harvest
			//agricultural survey
				...
				//annual
					use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/secta11c3q12_harvestw5.dta", clear			
						keep hhid s11c3q12
				...
				//annual
					use "`base'/Source Data/Nigeria GHS Wave 5/RAW DTA files/secta11c3_harvestw5.dta", clear
	...
	//Post Planting
		//agricultural survey
			//seed expenditures --- purchase of seeds expenses
			//annual
			use "`base'/Source Data/Nigeria GHS Wave 4/RAW DTA files/sect11e1_plantingw4.dta", clear
				keep hhid s11eq21
			...
			//seed expenditures --- transportation expenses for seeds aquisition
			//annual
			use "`base'/Source Data/Nigeria GHS Wave 4/RAW DTA files/sect11e2_plantingw4.dta", clear
	...
	//Harvest
		//agricultural survey
			//input expenditures namely fertilizer and machinery purchase  --- transportation expenses
			//annual
			use "`base'/Source Data/Nigeria GHS Wave 4/RAW DTA files/secta11c3q12_harvestw4.dta", clear			
				keep hhid s11c3q12
				rename s11c3q12 fert_pest_mach_transport_exp
			...
			//input expenditures namely fertilizer and machinery purchase
			//annual
				use "`base'/Source Data/Nigeria GHS Wave 4/RAW DTA files/secta11c3_harvestw4.dta", clear
	...
	//saving
	save "`base'/Stata Code/Stata Data Landing/input_expenditure_data.dta", replace