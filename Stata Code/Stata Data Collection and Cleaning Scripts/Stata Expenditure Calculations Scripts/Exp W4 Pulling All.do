//This file runs the subscripts that collect nonfarm expenditure data, then appends the data by wave for use in the DML data prep script.
	...
	//doing pre req files
	do "${base}/Stata Expenditure Calculations Scripts/Exp W4 Nonfood Expenditures.do"
	do "${base}/Stata Expenditure Calculations Scripts/Exp W4 Food Expenditures.do"
